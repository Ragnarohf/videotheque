...
class FilmController
{
    ...
    public function list($order, $offset, $limit)
    { //je propose à l'utilisateur un order et une limite

        $filmModel = new FilmModel;
        $resultFilmModel = $filmModel->selectList($order, $offset, $limit);
        $nbFilm = count($filmModel->findAll());
        $nbPage = $nbFilm / $limit;
        var_dump($nbFilm, $nbPage);

        return [$resultFilmModel, $nbPage];
    }
